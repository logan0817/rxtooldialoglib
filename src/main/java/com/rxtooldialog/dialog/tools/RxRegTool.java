package com.rxtooldialog.dialog.tools;
...
public class RxRegTool {
    ...
    public static boolean isMobileSimple(String string) {
        return isMatch(RxConstTool.REGEX_MOBILE_SIMPLE, string);
    }
    ...
    public static boolean isIDCard15(String string) {
        return isMatch(RxConstTool.REGEX_IDCARD15, string);
    }
    ...
    public static boolean isIDCard18(String string) {
        return isMatch(RxConstTool.REGEX_IDCARD18, string);
    }
    ...
    public static boolean isEmail(String string) {
        return isMatch(RxConstTool.REGEX_EMAIL, string);
    }
    ...
    public static boolean isChz(String string) {
        return isMatch(RxConstTool.REGEX_CHZ, string);
    }
    ...
    public static boolean isUsername(String string) {
        return isMatch(RxConstTool.REGEX_USERNAME, string);
    }
    ...
    public static boolean isDate(String string) {
        return isMatch(RxConstTool.REGEX_DATE, string);
    }
    ...
    public static boolean isIP(String string) {
        return isMatch(RxConstTool.REGEX_IP, string);
    }
